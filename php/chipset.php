...
<!-- content area -->    
    <div class="row"> 
        <div class="grid_5">
            <h2 class="first-header"><center>CHIPSET</center></h2>
            <img src="img/cns.jpg" />
            <form method="GET" action="?action=cns">
                <input type="hidden" name="action" value="cns">
                <?php if(isset($_GET['led04']) && ($_GET['led04']=='on')){ ?>
                    <button type="submit" value="off" class="buttonlink" name="led04">Desligar</button>
                <?php }else{ ?>
                    <button type="submit" value="on" class="buttonlink" name="led04">Ligar</button>
                <?php } ?>
            </form>
        </div>
        <div class="grid_7">
