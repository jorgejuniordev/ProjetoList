...
<!-- content area -->    
    <div class="row"> 
        <div class="grid_5">
            <h2 class="first-header"><center>Porta Paralelas e USB</center></h2>
            <img src="img/ppa.jpg" />
            <form method="GET" action="?action=ppa">
                <input type="hidden" name="action" value="ppa">
                <?php if(isset($_GET['led08']) && ($_GET['led08']=='on')){ ?>
                    <button type="submit" value="off" class="buttonlink" name="led08">Desligar</button>
                <?php }else{ ?>
                    <button type="submit" value="on" class="buttonlink" name="led08">Ligar</button>
                <?php } ?>
            </form>
        </div>
        <div class="grid_7">
